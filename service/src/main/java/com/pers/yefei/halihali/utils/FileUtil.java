...
public class FileUtil {
	...
	public static String readContent(InputStream is, String encoding){
		try{
			byte[] contentByteArray = readContentByteArray(is);

			String content = new String(contentByteArray, encoding);
			return content;
		}catch(Exception ex){
			logger.error(ex.toString(),ex);
			return "";
	...
	public static byte[] readContentByteArray(String filePath) throws FileNotFoundException {
		FileInputStream fis = new FileInputStream(filePath);
		return readContentByteArray(fis);
	}

	public static byte[] readContentByteArray(InputStream is){
		try{
	...
	public static void writeFileData(String filePath, byte[] data) throws IOException {
		if(data ==null){
			return;
		}
	...
	public static void appendFileData(String filePath, byte[] data) {
		if(data ==null){
			return;
		}
